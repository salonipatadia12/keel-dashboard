...
export default function Pitch({
  ...
  return (
    <section className="rounded-2xl bg-gradient-to-br from-surface via-surface to-surface2 border border-line shadow-card overflow-hidden relative">
      <div className="absolute top-0 left-1/4 w-72 h-72 bg-accent/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-72 h-72 bg-sub/8 rounded-full blur-3xl pointer-events-none" />
      <div className="relative p-7">
        ...
        <p className="text-xl text-ink leading-relaxed font-medium tracking-tight max-w-4xl">
          ...
          <span className="bg-bad/15 text-bad2 border border-bad/30 px-2 py-0.5 rounded-md font-semibold">
            {currentScore}-point friction wall
          </span>{' '}
          today. Keel replaces the menu tree with a voice agent that drops
          friction by{' '}
          <span className="bg-good/15 text-good2 border border-good/30 px-2 py-0.5 rounded-md font-semibold">
            {drop} points
          </span>
        ...
        <div className="mt-6 flex items-center gap-3">
          <button className="text-sm text-bg bg-gradient-to-r from-accent to-sub hover:opacity-90 rounded-lg px-5 py-2.5 transition font-semibold shadow-glow">
